...
- **Линии** между точками-якорями — сплошная, пунктир (короткий / обычный / длинный), двойная сплошная, белые и жёлтые стили G87, бордюр; настраиваемая кривизна и видимость отдельных сегментов.
